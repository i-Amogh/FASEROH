...
class Trainer:
    ...
    def _train_epoch(self, dataloader: DataLoader, epoch: int) -> Dict[str, float]:
        ...
        for batch_idx, batch in enumerate(dataloader):
            ...
            # =========================================================
            # CRITICAL FIX 1: You MUST zero the gradients every batch!
            # =========================================================
            self.optimizer.zero_grad()
            ...
            # =========================================================
            # CRITICAL FIX 2: Hardcoded LSTM Gradient Ceiling (1.0)
            # =========================================================
            self.scaler.unscale_(self.optimizer)
            ...
            # (Notice we completely removed the OneCycleLR batch step here)
